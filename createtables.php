...
(2,'IT21002','Emily Smith','abc@gmail.com'),
...
(14,'CS21002','Isabella Rodriguez','abc@gmail.com'),
...
(22,'CS21010','Emily Brown','abc@gmail.com'),
...
values
  ...
  (2,'Design and Analysis of Algorithm','CO215',3),
  (3,'Cryptography & Network Security','CS112',4),
  (4,'ARTIFICIAL INTELLIGENCE','CS670',4),
  (5,'THEORY OF COMPUTATION ','CO432',3),
  (6,'Soft Computing ','CS673',1)";
$s = $dbo->conn->prepare($c);
try {
  $s->execute();
} catch (PDOException $o) {
